...
# --------------------------
grid.arrange(
  dotplot(enrich_WT_vs_A$under, showCategory = 10) + ggtitle("WT vs A - Down"),
  dotplot(enrich_WT_vs_A$over, showCategory = 10) + ggtitle("WT vs A - Up"),
  dotplot(enrich_WT_vs_D$under, showCategory = 10) + ggtitle("WT vs D - Down"),
  dotplot(enrich_WT_vs_D$over, showCategory = 10) + ggtitle("WT vs D - Up"),
  ncol = 2,
