...
res_WT_vs_A <- readRDS(file.path(RDS_DIR, "res_WT_vs_A.rds"))
res_WT_vs_D <- readRDS(file.path(RDS_DIR, "res_WT_vs_D.rds"))
enrich_WT_vs_A_over <- readRDS(file.path(RDS_DIR, "enrich_WT_vs_A_over.rds"))
enrich_WT_vs_A_under <- readRDS(file.path(RDS_DIR, "enrich_WT_vs_A_under.rds"))
enrich_WT_vs_D_over <- readRDS(file.path(RDS_DIR, "enrich_WT_vs_D_over.rds"))
enrich_WT_vs_D_under <- readRDS(file.path(RDS_DIR, "enrich_WT_vs_D_under.rds"))
...
grid.arrange(
  dotplot(enrich_WT_vs_A_under, showCategory=20) + ggtitle("Underexpressed"),
  dotplot(enrich_WT_vs_A_over, showCategory=20) + ggtitle("Overexpressed"),
  ncol=2,
...
grid.arrange(
  dotplot(enrich_WT_vs_D_under, showCategory=20) + ggtitle("Underexpressed"),
  dotplot(enrich_WT_vs_D_over, showCategory=20) + ggtitle("Overexpressed"),
  ncol=2,
